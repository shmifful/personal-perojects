...
class snake:
        ...
        def move(self, win):
                bg = (random.randint(120,255), random.randint(120,255), random.randint(120,255))
                win.fill(bg)
                self.keys = pygame.key.get_pressed()
                ...
                self.snake = pygame.draw.rect(self.win, (colour(),colour(),colour()), (self.x, self.y, 25, self.width))
                for pos in self.body:
                    pygame.draw.rect(self.win, (colour(),colour(),colour()), (pos[0], pos[1], 25, self.width))
        ...
        def food(self, win):
                pygame.draw.rect(self.win, (random.randint(0,255),0,0), (self.a, self.b,25,25))
...
##name.pack()
##Button(win, text = "SUBMIT", command = game).pack()
##win.mainloop()
